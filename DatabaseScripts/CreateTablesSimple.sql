...
-- 创建刀模信息表
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='DieInfo' AND xtype='U')
BEGIN
...
-- 创建刀模工序表
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='DieProcess' AND xtype='U')
BEGIN
...
-- 创建改刀记录表
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='DieModificationRecord' AND xtype='U')
BEGIN
...
-- 创建扫码报产记录表
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='ScanReportRecord' AND xtype='U')
BEGIN
...
-- 创建索引
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieInfo_WorkOrderNo')
CREATE INDEX IX_DieInfo_WorkOrderNo ON DieInfo(WorkOrderNo);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieInfo_CustomerName')
CREATE INDEX IX_DieInfo_CustomerName ON DieInfo(CustomerName);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieInfo_Status')
CREATE INDEX IX_DieInfo_Status ON DieInfo([Status]);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieInfo_CreateTime')
CREATE INDEX IX_DieInfo_CreateTime ON DieInfo(CreateTime);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieProcess_DieID')
CREATE INDEX IX_DieProcess_DieID ON DieProcess(DieID);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_DieModificationRecord_DieID')
CREATE INDEX IX_DieModificationRecord_DieID ON DieModificationRecord(DieID);

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name='IX_ScanReportRecord_WorkOrderNo')
